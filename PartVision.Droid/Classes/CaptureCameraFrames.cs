...
namespace PartVision.Droid
{
	public class CaptureCameraFrames : Fragment, ICaptureFrames
	{
		...
		public void WatchForGesture(Action<GestureCommand> callback)
		{
			gestureRecognizedCallback = callback;
			imageAvailableListener.analyzing = true;
		}
		#endregion
		...
		public void WatchForPart(Action<string> partCallback)
		{
